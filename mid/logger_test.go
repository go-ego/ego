...
func TestLogger(t *testing.T) {
	...
	router.GET("/example", func(c *ego.Context) {})
	router.POST("/example", func(c *ego.Context) {})
	router.PUT("/example", func(c *ego.Context) {})
	router.DELETE("/example", func(c *ego.Context) {})
	router.PATCH("/example", func(c *ego.Context) {})
	router.HEAD("/example", func(c *ego.Context) {})
	router.OPTIONS("/example", func(c *ego.Context) {})
...
func TestErrorLogger(t *testing.T) {
	...
	router.GET("/error", func(c *ego.Context) {
		c.Error(errors.New("this is an error"))
	})
	router.GET("/abort", func(c *ego.Context) {
		c.AbortWithError(401, errors.New("no authorized"))
	})
	router.GET("/print", func(c *ego.Context) {
		c.Error(errors.New("this is an error"))
		c.String(500, "hola!")
	})
...
func TestSkippingPaths(t *testing.T) {
	...
	router.GET("/logged", func(c *ego.Context) {})
	router.GET("/skipped", func(c *ego.Context) {})
